...
public:
    ...
    std::unique_ptr<std::map<SpiceDouble, ExtendedBodyState>> get_messenger_between_km(SpiceDouble start_date, SpiceDouble end_date, ExtendedBodyState start_state) const;
};
